...
let virtual-env = "C:\my projects\DjangoProject\TopLearn(django_version)\TopLearn\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\my projects\DjangoProject\TopLearn(django_version)\TopLearn\venv\Scripts\deactivate.nu"
